...
change_lxterm () {
	...
	sed -i -e 's/bgcolor=.*/bgcolor=#131519/g'                   "$terminal_cfg"
...
obconfig 'Kripton' 'NLIMC' 'Noto Sans' '9' && openbox --reconfigure

# THEME | ICON | CURSOR
change_gtk 'Kripton' 'Zafiro' 'Fluent-Dark' && sleep 2 && lxpanelctl restart
