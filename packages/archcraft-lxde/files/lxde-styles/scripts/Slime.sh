...
change_lxterm () {
	...
	sed -i -e 's/palette_color_0=.*/palette_color_0=#383a42/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_1=.*/palette_color_1=#e45649/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_2=.*/palette_color_2=#50a14f/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_3=.*/palette_color_3=#c18401/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_4=.*/palette_color_4=#0184bc/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_5=.*/palette_color_5=#a626a4/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_6=.*/palette_color_6=#0997b3/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_7=.*/palette_color_7=#909090/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_8=.*/palette_color_8=#383a42/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_9=.*/palette_color_9=#e45649/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_10=.*/palette_color_10=#50a14f/g' "$terminal_cfg"
	sed -i -e 's/palette_color_11=.*/palette_color_11=#c18401/g' "$terminal_cfg"
	sed -i -e 's/palette_color_12=.*/palette_color_12=#0184bc/g' "$terminal_cfg"
	sed -i -e 's/palette_color_13=.*/palette_color_13=#a626a4/g' "$terminal_cfg"
	sed -i -e 's/palette_color_14=.*/palette_color_14=#0997b3/g' "$terminal_cfg"
	sed -i -e 's/palette_color_15=.*/palette_color_15=#909090/g' "$terminal_cfg"
}
...
# SCHEME | FONT
change_geany 'slime' 'JetBrains Mono 10'

# THEME | LAYOUT | FONT | SIZE
obconfig 'Slime' 'CLM' 'Noto Sans' '9' && openbox --reconfigure

# THEME | ICON | CURSOR
change_gtk 'Slime' 'Luv-Folders' 'Qogirr-Dark' && sleep 2 && lxpanelctl restart
