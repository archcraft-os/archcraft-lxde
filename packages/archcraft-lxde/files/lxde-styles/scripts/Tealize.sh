...
change_lxterm () {
	...
	sed -i -e 's/bgcolor=.*/bgcolor=#232735/g'                   "$terminal_cfg"
	sed -i -e 's/fgcolor=.*/fgcolor=#7C84A8/g'                   "$terminal_cfg"
...
obconfig 'Juno-palenight' 'NLIMC' 'Noto Sans' '9' && openbox --reconfigure

# THEME | ICON | CURSOR
change_gtk 'Juno-palenight' 'Luv-Folders-Dark' 'Vimix' && sleep 2 && lxpanelctl restart
