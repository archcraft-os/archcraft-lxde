...
change_lxterm () {
	...
	sed -i -e 's/bgcolor=.*/bgcolor=#141c21/g'                   "$terminal_cfg"
	sed -i -e 's/fgcolor=.*/fgcolor=#93a1a1/g'                   "$terminal_cfg"
	sed -i -e 's/palette_color_0=.*/palette_color_0=#263640/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_1=.*/palette_color_1=#d12f2c/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_2=.*/palette_color_2=#819400/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_3=.*/palette_color_3=#B08500/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_4=.*/palette_color_4=#2587CC/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_5=.*/palette_color_5=#696EBF/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_6=.*/palette_color_6=#289C93/g'   "$terminal_cfg"
	...
	sed -i -e 's/palette_color_9=.*/palette_color_9=#FA3935/g'   "$terminal_cfg"
	sed -i -e 's/palette_color_10=.*/palette_color_10=#A4BD00/g' "$terminal_cfg"
	sed -i -e 's/palette_color_11=.*/palette_color_11=#D9A400/g' "$terminal_cfg"
	sed -i -e 's/palette_color_12=.*/palette_color_12=#2CA2F5/g' "$terminal_cfg"
	sed -i -e 's/palette_color_13=.*/palette_color_13=#8086E8/g' "$terminal_cfg"
	sed -i -e 's/palette_color_14=.*/palette_color_14=#33C5BA/g' "$terminal_cfg"
...
obconfig 'Arc' 'NLIMC' 'Noto Sans' '9' && openbox --reconfigure

# THEME | ICON | CURSOR
change_gtk 'Arc' 'Arc-Circle' 'Future' && sleep 2 && lxpanelctl restart
